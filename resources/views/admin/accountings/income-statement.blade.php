...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
    <div>
        <h2 class="text-xl font-bold text-gray-900">Erfolgsrechnung</h2>
    ...
    <div class="flex gap-2">
        <a href="{{ route('admin.accountings.balanceSheet', $accounting) }}" class="px-4 py-2 bg-white text-gray-700 text-sm rounded-lg border border-gray-300 hover:bg-gray-50">Bilanz</a>
...
<div class="mb-6 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div>
            <p class="text-xs font-medium text-gray-500 uppercase">{{ $profitLoss >= 0 ? 'Gewinn' : 'Verlust' }}</p>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase w-32">Betrag</th>
                    </tr>
                </thead>
                ...
                <tfoot class="bg-gray-50">
                    <tr class="font-bold">
                        <td colspan="2" class="px-4 py-3 text-sm text-gray-900">Total Ertrag</td>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tfoot class="bg-gray-50">
                    <tr class="font-bold">
                        <td colspan="2" class="px-4 py-3 text-sm text-gray-900">Total Aufwand</td>
    ...
    <table class="min-w-full">
        <tbody>
            <tr class="border-b border-gray-200">
                <td class="px-6 py-3 text-sm text-gray-600">Total Ertrag</td>
                <td class="px-6 py-3 text-sm text-right font-mono text-green-700 font-medium">{{ number_format($totalIncome, 2, '.', "'") }}</td>
            </tr>
            <tr class="border-b border-gray-200">
                <td class="px-6 py-3 text-sm text-gray-600">Total Aufwand</td>
