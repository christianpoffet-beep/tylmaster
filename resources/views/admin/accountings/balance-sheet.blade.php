...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
    ...
    <div class="flex gap-2">
        <a href="{{ route('admin.accountings.incomeStatement', $accounting) }}" class="px-4 py-2 bg-white text-gray-700 text-sm rounded-lg border border-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50 dark:bg-gray-700/50">Erfolgsrechnung</a>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
            ...
            <div class="space-y-1 text-sm">
                <div class="flex justify-between"><span class="text-gray-600 dark:text-gray-300">Aktiven</span><span class="font-mono">{{ number_format($totalAssetsOpening, 2, '.', "'") }}</span></div>
                <div class="flex justify-between"><span class="text-gray-600 dark:text-gray-300">Passiven</span><span class="font-mono">{{ number_format($totalLiabilitiesOpening, 2, '.', "'") }}</span></div>
        ...
        <div>
            ...
            <div class="space-y-1 text-sm">
                <div class="flex justify-between"><span class="text-gray-600 dark:text-gray-300">Aktiven</span><span class="font-mono">{{ number_format($totalAssetsClosing, 2, '.', "'") }}</span></div>
                <div class="flex justify-between"><span class="text-gray-600 dark:text-gray-300">Passiven</span><span class="font-mono">{{ number_format($totalLiabilitiesClosing, 2, '.', "'") }}</span></div>
