    ...
    <form method="POST" action="{{ route('admin.artworks.store') }}" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
            <div>
                ...
                <input type="text" name="title" id="title" value="{{ old('title') }}" required placeholder="z.B. Albumtitel" class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div>
                <label for="artwork_file" class="block text-sm font-medium text-gray-700 mb-1">Artwork hochladen</label>
            ...
            <div>
                ...
                <input type="number" name="yoc" id="yoc" value="{{ old('yoc') }}" min="1900" max="{{ date('Y') + 1 }}" placeholder="{{ date('Y') }}" class="w-32 rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
        ...
        <div class="mt-4 flex gap-3">
            ...
            <a href="{{ route('admin.artworks.index') }}" class="px-5 py-2.5 bg-white text-gray-700 text-sm font-medium rounded-lg border border-gray-300 hover:bg-gray-50">Abbrechen</a>
        </div>
    </form>
</div>
@endsection
