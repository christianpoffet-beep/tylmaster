...
<div class="max-w-3xl">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div>
                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Release</dt>
                <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">
                    @if($track->release)
                        <a href="{{ route('admin.releases.show', $track->release) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">{{ $track->release->title }}</a>
                    @else
                        -
                    @endif
                </dd>
