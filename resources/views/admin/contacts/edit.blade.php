...
<div class="max-w-3xl">
    <form method="POST" action="{{ route('admin.contacts.update', $contact) }}" enctype="multipart/form-data">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-6">
            <div>
                ...
                @if($contact->avatar_path)
                    <div class="flex items-center gap-3 mb-2">
                        <img src="{{ Storage::disk('public')->url($contact->avatar_path) }}" alt="Avatar" class="h-16 w-16 rounded-full object-cover border">
            ...
            {{-- Projekte --}}
            <div>
                @include('admin.partials.project-search', ['selected' => $contact->projects])
            </div>
        ...
        <div class="mt-4 flex gap-3">
            ...
            <a href="{{ route('admin.contacts.show', $contact) }}" class="px-5 py-2.5 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 text-sm font-medium rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700">Abbrechen</a>
        </div>
    </form>
