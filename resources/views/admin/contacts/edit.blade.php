...
<div class="max-w-3xl">
    <form method="POST" action="{{ route('admin.contacts.update', $contact) }}" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="first_name" id="first_name" value="{{ old('first_name', $contact->first_name) }}" required class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
                    @error('first_name') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label for="last_name" class="block text-sm font-medium text-gray-700 mb-1">Nachname *</label>
                    <input type="text" name="last_name" id="last_name" value="{{ old('last_name', $contact->last_name) }}" required class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div x-data="{ emails: {{ json_encode(old('secondary_emails', $contact->secondary_emails ?? [])) }} }">
                ...
                <input type="email" name="email" id="email" value="{{ old('email', $contact->email) }}" placeholder="Primäre E-Mail" class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div x-data="{ phones: {{ json_encode(old('secondary_phones', $contact->secondary_phones ?? [])) }} }">
                ...
                <input type="text" name="phone" id="phone" value="{{ old('phone', $contact->phone) }}" placeholder="Primäre Telefonnummer" class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div>
                ...
                <input type="text" name="street" id="street" value="{{ old('street', $contact->street) }}" class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            ...
            <div>
                ...
                <input type="text" name="iban" id="iban" value="{{ old('iban', $contact->iban) }}" placeholder="CH00 0000 0000 0000 0000 0" class="w-full rounded-lg border-gray-300 text-sm font-mono focus:border-blue-500 focus:ring-blue-500">
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label for="bank_name" class="block text-sm font-medium text-gray-700 mb-1">Name Bank</label>
                    <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $contact->bank_name) }}" class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
                <div>
                    <label for="bic" class="block text-sm font-medium text-gray-700 mb-1">BIC/SWIFT</label>
                    <input type="text" name="bic" id="bic" value="{{ old('bic', $contact->bic) }}" class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="3" class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">{{ old('notes', $contact->notes) }}</textarea>
            </div>
        ...
        <div class="mt-4 flex gap-3">
            ...
            <a href="{{ route('admin.contacts.show', $contact) }}" class="px-5 py-2.5 bg-white text-gray-700 text-sm font-medium rounded-lg border border-gray-300 hover:bg-gray-50">Abbrechen</a>
        </div>
    </form>
