...
<div class="max-w-3xl">
    <form method="POST" action="{{ route('admin.contacts.store') }}" enctype="multipart/form-data">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="last_name" id="last_name" value="{{ old('last_name') }}" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 text-sm focus:border-blue-500 focus:ring-blue-500">
                    @error('last_name') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label for="first_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Vorname *</label>
                    <input type="text" name="first_name" id="first_name" value="{{ old('first_name') }}" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 text-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="gender" id="gender" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 text-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <option value="other" {{ old('gender') === 'other' ? 'selected' : '' }}>Nicht definiert</option>
                    </select>
                </div>
                <div>
                    <label for="birth_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Geburtsdatum</label>
                    <input type="date" name="birth_date" id="birth_date" value="{{ old('birth_date') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 text-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div x-data="{ emails: {{ json_encode(old('secondary_emails', [])) }} }">
                ...
                <input type="email" name="email" id="email" value="{{ old('email') }}" placeholder="Primäre E-Mail" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 text-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" class="space-y-6 pt-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            @include('admin.partials.country-select', ['name' => 'nationality', 'label' => 'Nationalität', 'value' => old('nationality', '')])
                        </div>
                        <div>
                            <label for="ahv_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">AHV-Nr.</label>
                            <input type="text" name="ahv_number" id="ahv_number" value="{{ old('ahv_number') }}" placeholder="756.XXXX.XXXX.XX"
                    ...
                    <div x-data="{ phones: {{ json_encode(old('secondary_phones', [])) }} }">
                        ...
                        <input type="text" name="phone" id="phone" value="{{ old('phone') }}" placeholder="Primäre Telefonnummer" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 text-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="date" name="death_date" id="death_date" value="{{ old('death_date') }}" class="w-full sm:w-1/3 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 text-sm focus:border-blue-500 focus:ring-blue-500">
        ...
        <div class="mt-4 flex gap-3">
            ...
            <a href="{{ route('admin.contacts.index') }}" class="px-5 py-2.5 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 text-sm font-medium rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700">Abbrechen</a>
        </div>
    </form>
</div>
@endsection
