            ...
            <tbody class="divide-y divide-gray-200">
                @forelse($contacts as $contact)
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 text-xs text-gray-400 font-mono">{{ $contact->ref_nr }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-4 py-8 text-center text-sm text-gray-500">Keine Kontakte gefunden.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
