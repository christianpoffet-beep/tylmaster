...
<div class="max-w-3xl">
    <form method="POST" action="{{ route('admin.tasks.store') }}" enctype="multipart/form-data">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-6">
            ...
            <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300">Dokumente</h3>
            ...
            <div>
                @include('admin.partials.project-search', ['selected' => collect(), 'projectInputName' => 'linked_project_ids[]'])
            </div>

            <div>
                @include('admin.partials.submission-search', ['selected' => collect()])
            </div>
        </div>
        ...
        <div class="mt-4 flex gap-3">
            ...
            <a href="{{ route('admin.tasks.index') }}" class="px-5 py-2.5 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 text-sm font-medium rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700">Abbrechen</a>
        </div>
    </form>
</div>
@endsection
