    ...
    <form method="POST" action="{{ route('admin.genres.update', $genre) }}">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $genre->name) }}" required class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
