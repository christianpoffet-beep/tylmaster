    ...
    <form method="POST" action="{{ route('admin.contract-templates.store') }}">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="z.B. Publishing Standard, Label Exclusive..." class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <textarea name="default_terms" id="default_terms" rows="12" class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500 font-mono" placeholder="Vertragstext, der beim Erstellen eines neuen Vertrags vorausgefüllt wird...">{{ old('default_terms') }}</textarea>
