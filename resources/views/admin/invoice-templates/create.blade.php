...
<div class="max-w-3xl" x-data="templateForm()">
    <div class="mb-6">
        <h2 class="text-xl font-bold text-gray-900">Neue Rechnungsvorlage</h2>
    ...
    <form method="POST" action="{{ route('admin.invoice-templates.store') }}" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500" placeholder="z.B. The Yelling Light GmbH">
            ...
            <div class="border-t border-gray-200 pt-6">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="vat_rate" id="vat_rate" value="{{ old('vat_rate') }}" step="0.01" min="0" max="100" class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500" placeholder="z.B. 8.10">
                    ...
                    <div>
                        ...
                        <input type="number" name="payment_terms_days" id="payment_terms_days" value="{{ old('payment_terms_days', 30) }}" required min="0" max="365" class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                </div>
            </div>
            ...
            {{-- Logo --}}
            <div class="border-t border-gray-200 pt-6" x-data="{ logoSource: '{{ old('logo_source', 'avatar') }}' }">
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <textarea name="footer_text" id="footer_text" rows="2" class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Wird am Ende der Rechnung angezeigt">{{ old('footer_text') }}</textarea>
            </div>
        </div>
