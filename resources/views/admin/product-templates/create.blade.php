...
@section('title', 'Neue Produktvorlage')

@section('content')
<div class="max-w-3xl">
    <form method="POST" action="{{ route('admin.product-templates.store') }}">
        @csrf
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-6">
            <div>
                <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Name *</label>
                <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="z.B. Standard Album Release, Merchandise Set..." class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 text-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                @php $selectedTypes = old('default_product_types', []); @endphp
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <textarea name="default_release_info" id="default_release_info" rows="6" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 text-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Release-Informationen, die beim Verwenden der Vorlage vorausgefüllt werden...">{{ old('default_release_info') }}</textarea>
        ...
        <div class="mt-4 flex gap-3">
            ...
            <a href="{{ route('admin.product-templates.index') }}" class="px-5 py-2.5 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 text-sm font-medium rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700">Abbrechen</a>
        </div>
    </form>
</div>
@endsection
