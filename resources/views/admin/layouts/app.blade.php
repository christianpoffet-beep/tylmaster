                    ...
                    <div class="hidden md:flex items-center gap-0.5 flex-1 min-w-0">
                        ...
                        @php
                            ...
                            $projekteItems = [
                                ...
                                ['route' => 'admin.releases.index', 'label' => 'Produkte', 'match' => 'admin.releases.*', 'icon' => 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4'],
                                ...
                                ['route' => 'admin.tracks.index', 'label' => 'Tracks', 'match' => 'admin.tracks.*', 'icon' => 'M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3'],
                        ...
                        {{-- Kampagnen Dropdown --}}
                        @php
                            $kampagnenActive = request()->routeIs('admin.address-circles.*') || request()->routeIs('admin.campaigns.*') || request()->routeIs('admin.content-posts.*');
                            $kampagnenItems = [
                                ...
                                ['route' => 'admin.content-posts.index', 'label' => 'Content-Planer', 'match' => 'admin.content-posts.*', 'icon' => 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z'],
                        ...
                        @php
                            ...
                            $settingsItems = [
                                ...
                                ['route' => 'admin.settings.credit-roles', 'label' => 'Track-Credits', 'match' => 'admin.settings.credit-roles', 'icon' => 'M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3'],
                                ['route' => 'admin.settings.instruments', 'label' => 'Instrumente', 'match' => 'admin.settings.instruments', 'icon' => 'M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3'],
                                ['route' => 'admin.settings.product-types', 'label' => 'Produkttypen', 'match' => 'admin.settings.product-types', 'icon' => 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4'],
                                'divider',
                                ...
                                ['route' => 'admin.product-templates.index', 'label' => 'Produktvorlagen', 'match' => 'admin.product-templates.*', 'icon' => 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4'],
                                'divider',
