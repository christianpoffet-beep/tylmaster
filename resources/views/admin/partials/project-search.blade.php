...
<div x-data="projectSearch()" class="relative">
    ...
    <div x-show="selected.length > 0" class="flex flex-wrap gap-2 mt-2">
        <template x-for="project in selected" :key="project.id">
            <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium" :class="statusColorMap[project.status] || 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300'">
