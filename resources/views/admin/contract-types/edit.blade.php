...
<div class="max-w-lg">
    <form method="POST" action="{{ route('admin.contract-types.update', $contractType) }}">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $contractType->name) }}" required class="w-full rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div>
                ...
                <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $contractType->sort_order) }}" min="0" class="w-24 rounded-lg border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
        </div>
        ...
        <div class="mt-4 flex gap-3">
            ...
            <a href="{{ route('admin.contract-types.index') }}" class="px-5 py-2.5 bg-white text-gray-700 text-sm font-medium rounded-lg border border-gray-300 hover:bg-gray-50">Abbrechen</a>
        </div>
    </form>
    ...
    <div class="mt-8 pt-6 border-t border-gray-200">
        ...
        @if($usageCount > 0)
            <p class="text-sm text-gray-500">Dieser Typ wird von {{ $usageCount }} Vertrag/Verträgen verwendet und kann nicht gelöscht werden.</p>
        @else
